...
class UserControllerTest extends BaseControllerTest {
    ...
    @WithMockUser(username = "admin", roles = {"ADMIN"})
    public void shouldNotRemoveUserById() throws Exception {
        val user = UserDto.builder()
                .id("2")
                .build();
    ...
    @Test
    @DisplayName(value = "create new user")
    ...
    @Test
    @DisplayName(value = "update existed user")
    ...
    @Test
    @DisplayName(value = "not update existed user")

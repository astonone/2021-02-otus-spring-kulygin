package ru.otus.kulygin.templateservice.changelogs;
...
public class Changelog001 {
    ...
    @ChangeSet(order = "001", id = "2021-02-05--001-insert-template--vkulygin", author = "viktor.kulygin")
    public void insertTemplate(InterviewTemplateRepository interviewTemplateRepository) {

...
export class InterviewPageableDto {
    ...
    private _interviews: InterviewDto[] = [];

    constructor(totalSize: number, totalPageSize: number, currentPageSize: number, page: number, pageSize: number, interviews: InterviewDto[]) {
    ...
    get interviews(): InterviewDto[] {
        return this._interviews;
    }

    set interviews(value: InterviewDto[]) {

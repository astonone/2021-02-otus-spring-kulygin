...
export class UserService {
    ...
    constructor(private localStorageService: LocalStorageService,
        ...
        this.USER_LOGIN = this.SERVER_URL + '/interviewer/login';
        this.USER_AUTHENTICATE = this.SERVER_URL + '/interviewer/authenticate';
        this.GET_BY_ID = this.SERVER_URL + '/interviewer/{id}';
        this.DELETE = this.SERVER_URL + '/interviewer/{id}';
        this.SAVE = this.SERVER_URL + '/interviewer/';
    }
    ...
    public login(interviewerDto: InterviewerDto): Observable<Object> {
        return this.http.post<Observable<Object>>(this.USER_LOGIN, InterviewerDto.createNewObjectFromDto(interviewerDto).toObject());
    }

    public authenticate(): Observable<InterviewerDto> {
        return this.http.post<InterviewerDto>(this.USER_AUTHENTICATE, null, this.getOptions());
    }

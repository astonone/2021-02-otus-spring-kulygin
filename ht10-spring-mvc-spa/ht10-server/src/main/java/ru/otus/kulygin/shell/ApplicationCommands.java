...
public class ApplicationCommands {
    ...
    @ShellMethod(value = "Get genre by id(String id)", key = {"gg", "genre-get"})
    ...
    @ShellMethod(value = "Delete genre by id(String id)", key = {"gd", "genre-delete"})
    ...
    public String insertGenre(@ShellOption String name) {
        val genreForSave = Genre.builder()
                .name(name)
                .build();
        genreService.save(genreForSave);
    ...
    @ShellMethod(value = "Get author by id(String id)", key = {"ag", "author-get"})
    ...
    @ShellMethod(value = "Delete author by id(String id)", key = {"ad", "author-delete"})
    ...
    public String insertAuthor(@ShellOption String fname, @ShellOption String lname) {
        val authorForSave = Author.builder()
                ...
                .lastName(lname)
                .build();
        authorService.save(authorForSave);
    ...
    @ShellMethod(value = "Get book by id(String id)", key = {"bg", "book-get"})
    ...
    @ShellMethod(value = "Delete book by id(String id)", key = {"bd", "book-delete"})
    ...
    @ShellMethod(value = "Insert new book(String title, String authorId, String genreId)", key = {"bi", "book-insert"})
    public String insertBook(@ShellOption String title, @ShellOption String authorId, @ShellOption String genreId) {
    ...
    @ShellMethod(value = "Add comment to book(String commentatorName, String text, String bookId)", key = {"ca", "comment-add"})
    public String addCommentToBook(@ShellOption String commentatorName, @ShellOption String text, @ShellOption String bookId) {
    ...
    @ShellMethod(value = "Add comment to book(String commentId)", key = {"cd", "comment-delete"})
    public String removeCommentFromBook(@ShellOption String commentId) {
        try {
